  ...
  names.forEach(function(name) {
    ...
    switch (name) {
      case 'junit':
        ...
        reporter = new Reporter(errorFormatter, config.junitReporter.outputFile, 
                                config.junitReporter.suite);
        
        break;
      case 'growl':
        Reporter = exports.Growl;
        reporter = new Reporter(errorFormatter, config.reportSlowerThan);
        break;
      default:
