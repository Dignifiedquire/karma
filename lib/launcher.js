...
var Launcher = function(emitter) {
  ...
  this.launch = function(names, port, urlRoot, timeout, retryLimit, config) {
    ...
    names.forEach(function(name) {
      ...
      if (name.match(/^BS::/)) {
        Cls = exports['BrowserStackBrowser'];
        browser = new Cls(Launcher.generateId(), emitter, name, config, port);
      } else {
...
exports.BrowserStackBrowser = require('./launchers/BrowserStack');